...
public class TipoInstalacionPK implements Serializable {

	private StringProperty nombre = new SimpleStringProperty();
	
	private BooleanProperty nombreNull = new SimpleBooleanProperty();
	
	public TipoInstalacionPK(final String nombre) {
		setNombre(nombre);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TipoInstalacionPK other = (TipoInstalacionPK) obj;
		if (nombre == null) {
	...
	public String toString() {
		...
		ret.append("es.rfgr.cr4vegas.modelo.dominio.mantenimiento.instalacion.TipoInstalacionPK: ");
