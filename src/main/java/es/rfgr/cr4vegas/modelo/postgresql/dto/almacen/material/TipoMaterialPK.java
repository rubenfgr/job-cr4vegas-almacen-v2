...
public class TipoMaterialPK implements Serializable {
	...
	public TipoMaterialPK(final String nombre) {
		setNombre(nombre);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TipoMaterialPK other = (TipoMaterialPK) obj;
		if (nombre == null) {
	...
	public String toString() {
		...
		ret.append("es.rfgr.cr4vegas.modelo.dominio.almacen.material.TipoMaterialPK: ");
