...
public abstract class OperaPK implements Serializable {
	...
	public OperaPK(final int codOperacion) {
	...
	public String toString() {
		return "OperaPK [codOperacion=" + codOperacion + ", codOperacionNull=" + codOperacionNull + "]";
	}
