...
public class ConexionAlmacen {
	...
	private static final String ERROR = "Conexion: ";
	...
	private static String JDBC_FILE_NAME = "es/rfgr/cr4vegas/modelo/postgresql/conexion/jdbc.properties";
	...
	private static void loadProperties() {
		try {
			prop.load(ConexionAlmacen.class.getClassLoader().getResourceAsStream(JDBC_FILE_NAME));
		} catch (IOException e) {
			e.printStackTrace();
		}
