...
public class RegistroImagenInstalacionPK implements Serializable {
	...
	public RegistroImagenInstalacionPK(final int codRegistro, final int codImagen) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RegistroImagenInstalacionPK other = (RegistroImagenInstalacionPK) obj;
		if (codImagen == null) {
	...
	public String toString() {
		...
		ret.append("es.rfgr.cr4vegas.modelo.dominio.mantenimiento.instalacion.RegistroImagenInstalacionPK: ");
