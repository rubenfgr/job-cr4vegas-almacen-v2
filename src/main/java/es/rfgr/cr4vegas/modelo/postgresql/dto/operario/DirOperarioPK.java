...
public class DirOperarioPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DirOperarioPK other = (DirOperarioPK) obj;
		if (codOp == null) {
			if (other.codOp != null)
				return false;
	...
	public String toString() {
		...
		ret.append("es.rfgr.cr4vegas.modelo.dominio.operario.DirOperarioPK: ");
