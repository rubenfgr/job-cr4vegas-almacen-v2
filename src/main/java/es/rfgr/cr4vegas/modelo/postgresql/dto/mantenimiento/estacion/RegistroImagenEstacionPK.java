...
public class RegistroImagenEstacionPK implements Serializable {
	...
	public RegistroImagenEstacionPK(final int codRegistro, final int codImagen) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RegistroImagenEstacionPK other = (RegistroImagenEstacionPK) obj;
		if (codImagen == null) {
	...
	public String toString() {
		...
		ret.append("es.rfgr.cr4vegas.modelo.dominio.mantenimiento.estacion.RegistroImagenEstacionPK: ");
